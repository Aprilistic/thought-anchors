...
MODEL_ARCHITECTURES: Dict[str, ModelArchitecture] = {
    ...
    "qwen3-4b": ModelArchitecture(36, 32, "Qwen3 4B Thinking (36 layers, 32 heads)"),
    ...
    # GPT models
    "gpt-oss-20b": ModelArchitecture(
        48, 48, "48 layers, 48 attention heads (estimated for 20B model)"
    ),
    # DeepSeek models
...
MODEL_PATHS: Dict[str, ModelPath] = {
    ...
    "qwen3-4b": ModelPath("Qwen/Qwen3-4B-Thinking-2507"),
    ...
    # DeepSeek models
    "DeepSeek-R1": ModelPath(
        "deepseek-ai/DeepSeek-R1-0528", local_path="/models/DeepSeek-R1"
    ),
}
